<div class="row">
    <div class="col-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Valid</li>
            </ol>
        </nav>
    </div>
    <div class="col-12">
    ...
    <div class="col-12">
        <div class="card p-4">
            <form action="<?= base_url('persetujuan/C_persetujuan/confirmValid/'.$header['id_trx_perencanaan'].'/'.$header['id_trx_perencanaan_detail']) ?>" method="post" class="row">
                <div class="col-3">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="indikator" id="indikator">
                            <?php foreach ($indikator as $ind): ?>      
                                <option value="<?= $ind['id_mst_indikator'] ?>"><?= $ind['nama_indikator'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
